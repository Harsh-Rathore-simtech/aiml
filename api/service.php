...
<?php $head_title="Service | Wooden Magic interiors"?>
...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 wow animated fadeInUp" data-wow-delay="0.1s">
                        <div class="service-two__single">
                            <div class="shape2"><img src="assets/img/shape/service-v2-shape2.png" alt=""></div>
                            ...
                            <div class="service-two__single-text">
                                <h2><a href="architecture.php">Machine Design</a></h2>
                                <p>Through a unique coN construction and design disciplines expertise Concor and
                                    delivers </p>
                            </div>

                            <div class="btn-box">
                                <a href="architecture.php">EXPLORE SERVICE</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow animated fadeInUp" data-wow-delay="0.3s">
                        <div class="service-two__single">
                            ...
                            <div class="service-two__single-text">
                                <h2><a href="architecture.php">General Contracting</a></h2>
                                <p>Through a unique coN construction and design disciplines expertise Concor and
                                    delivers </p>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow animated fadeInUp" data-wow-delay="0.5s">
                        <div class="service-two__single">
                            ...
                            <div class="service-two__single-text">
                                <h2><a href="architecture.php">Interior Design</a></h2>
                                <p>Through a unique coN construction and design disciplines expertise Concor and
                                    delivers </p>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 wow animated fadeInRight" data-wow-delay="0.1s">
                        <div class="why-choose-us-one__img">
                            <div class="shape1"><img src="assets/img/shape/why-choose-us-v1-shape1.png" alt=""></div>
                            <ul>
                                <li>
                                    <div class="img-box">
                    ...
                    <div class="col-xl-6 col-lg-6 wow animated fadeInUp" data-wow-delay="0.1s">
                        <div class="service-one__single">
                            ...
                            <div class="service-one__single-inner">
                                ...
                                <div class="content-box">
                                    <h2><a href="architecture.php">Project Planing</a></h2>
                                    <p>Through a unique combination of construction and design disciplines expertise,
                                        Concor and delivers world class</p>
                                    <div class="btn-box">
                                        <a href="architecture.php">EXPLORE SERVICE</a>
        ...
        <section class="feauture-three">
            <div class="shape1 float-bob-y"><img src="assets/img/shape/feauture-v3-shape1.png" alt=""></div>
            <div class="container">
                <div class="row">
