...
<?php $head_title="Ui/Ux Designing | Wooden Magic interiors"?>
                        ...
                        <div class="sidebar">
                            ...
                            <div class="sidebar__single sidebar__category">
                                ...
                                <ul class="sidebar__category-list">
                                    <li><a href="architecture.php">Architecture <span
                                                class="icon-left-arrow"></span></a></li>
                                    <li><a href="interior-design.php">Interior Design <span
                                                class="icon-left-arrow"></span></a></li>
                                    <li><a class="active" href="#">Ui/Ux Designing <span
                                                class="icon-left-arrow"></span></a></li>
                                    <li><a href="building-renovation.php">Building Renovation <span
                                                class="icon-left-arrow"></span></a></li>
                                    <li><a href="construction-site.php">Construction Site <span
                                                class="icon-left-arrow"></span></a></li>
                                    <li><a href="security-system.php">Security System <span
                                                class="icon-left-arrow"></span></a></li>
                                </ul>
                            </div>
                            <!--End Sidebar Single-->
